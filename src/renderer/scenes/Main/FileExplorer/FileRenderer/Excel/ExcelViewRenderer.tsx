...
export default function ExcelViewRenderer({
  ...
  const [showAdvancedFeatures, setShowAdvancedFeatures] = useState(true); // Default to showing advanced features in view mode
  ...
  return (
    <Box sx={{ height: isFullscreen ? '90vh' : '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box mb={2} display="flex" alignItems="center" justifyContent="between" gap={2}>
        <Box display="flex" alignItems="center" gap={1}>
          ...
          {/* View mode indicator - no duplicate title needed as copilot already shows it */}
          <Chip 
            label="View Mode" 
            size="small" 
            color="primary" 
      ...
      <TableContainer 
        ...
        sx={{ 
          flex: 1,
          maxHeight: isFullscreen ? 'calc(90vh - 300px)' : 'none',
          '& .MuiTableCell-root': {
            fontSize: `${fontSize}px`,
            padding: '4px 8px',
          ...
          '& .MuiTableCell-head': {
            ...
            borderBottom: (theme) => `1px solid ${theme.palette.divider}`,
            '&:hover': {
              backgroundColor: (theme) => theme.palette.mode === 'dark' ? theme.palette.grey[700] : '#e8e8e8'
            }
          },
          '& .row-header': {
            backgroundColor: (theme) => theme.palette.mode === 'dark' ? theme.palette.grey[800] : '#f5f5f5',
              ...
              {columnLetters.map(col => (
                <TableCell 
                  ...
                  sx={{
                    ...
                    cursor: 'pointer',
                    '&:hover': {
                      backgroundColor: (theme) => theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.12)' : '#e0e0e0'
                    }
                  }}
                >
      ...
      {/* Advanced features toggle - default to showing */}
